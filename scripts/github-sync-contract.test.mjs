...
test("GitHub sync runbook mirrors backlog taxonomy and project-scope blocker", () => {
	...
	for (const required of [
		...
		"Repo issues remain",
		"the synchronization surface until the board is created",
		...
		"Do not mark the Project board recovered until every open issue in the live issue bridge has a Project item or a documented skip reason.",
		"gh label create",
		"gh issue edit",
		"gh issue create",
