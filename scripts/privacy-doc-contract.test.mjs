...
test("privacy notes cover B-054 contact, analytics, retention, and review contracts", () => {
	...
	expectAll(content, [
		...
		"in-memory rate limit tracks a temporary abuse-control key from forwarded client IP headers when present, or the normalized email address when those headers are absent",
