...
test("deployment and operations runbooks cover B-062 rollback and incident requirements", () => {
	...
	expectAll(deployment, [
		...
		"Do not install, authenticate, create, link, deploy, or rollback Shuttle for a new launch.",
		"Run the Shuttle command snippets only when explicitly preserving or investigating legacy compatibility evidence.",
		"Legacy Shuttle commands must never replace Fly.io, Railway, or approved current-host evidence for #64.",
