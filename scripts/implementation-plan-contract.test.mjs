...
test("implementation plan has a current-state overlay for blocked goal continuations", () => {
	...
	containsAll(
		...
		[
			...
			"Project #1 lists/views with 19 fields, 15 issue items, and PR #6",
			"PR #6 is tracked as a Project item",
			"Phase 0 CI run",
			"Frontend verification job",
			"Rust verification job",
			"2026-05-25T12:44:49-04:00",
			...
			"installed skill snapshot authority hardening",
