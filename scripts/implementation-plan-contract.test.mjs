...
test("implementation plan has a current-state overlay for blocked goal continuations", () => {
	...
	containsAll(
		...
		[
			...
			"2026-05-25T18:41:47.441Z",
			"Provider preflight reports `wrangler`, `fly`,",
			"`railway` missing on this machine",
			"no provider/API env names present",
			"Only environment variable names and command presence",
			"secret values, provider account IDs, URLs, contact payloads, and raw",
