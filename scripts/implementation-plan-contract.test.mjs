...
test("implementation plan has a current-state overlay for blocked goal continuations", () => {
	...
	containsAll(
		...
		[
			...
			"Active phase/status source order:",
			"The Current Repo State / Issue Overlay, `docs/BACKLOG.md`, `docs/GITHUB_SYNC.md`, and launch runbooks are authoritative for active status.",
			...
			"2026-05-25T11:50:12-04:00",
			"af91564dc9a69a6a8327cb11bacafd3c1baf1fe2",
			"26408347438",
			"77736960650",
			"77736960667",
