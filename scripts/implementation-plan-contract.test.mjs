...
test("implementation plan has a current-state overlay for blocked goal continuations", () => {
	...
	containsAll(
		...
		[
			...
			"`repo`, `project`, and `workflow` scopes",
			"private repo access reports `ADMIN`",
			"Project #1 lists/views with 19 fields and 15 issue items",
			"Phase 0 CI run",
			"Frontend verification job",
			"Rust verification job",
			"2026-05-25T12:17:20-04:00",
			"a1abdfe4514d6c2e0213ed110dc237c3f084ae61",
			"26409403768",
			"77740295220",
			"77740295189",
			"GitHub Project permissions are no longer a current blocker",
			"Latest non-blocked local slice snapshot",
			"operations deployment command boundary hardening",
			"`docs/OPERATIONS.md`",
			"`scripts/operations-production-standard-contract.test.mjs`",
			"provider-specific commands, migration procedures, and rollback steps remain reference-only",
