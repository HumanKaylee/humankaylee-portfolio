...
Captured 2026-05-25T10:35:36-04:00 from the local GitHub CLI after Project
...
Project #1; the token exposes `project` as the full-control Project scope even
though `gh auth status` does not list `read:project` separately. No auth refresh
