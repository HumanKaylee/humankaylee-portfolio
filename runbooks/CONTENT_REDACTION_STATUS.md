...
| ----------------------------------------------------- | ------------------ | ---------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CLI Fleet Synchronization and MCP Rollout             | `publish`          | `reviewed`       | Safe outline with partial review, sanitized artifact labels, and an open item to expand the placeholder body with approved public evidence. | Replace the placeholder body with a generalized architecture, summarized verification matrix, and sanitized operator checklist; complete every guide checklist item before changing status to `approved`. |
...
| Remote Workstation Recovery and Operational Debugging | `publish`          | `reviewed`       | Safe outline with partial review, redacted artifact labels, and an open item to add approved incident evidence.                             | Convert the story into a generalized troubleshooting flow with summarized evidence only; omit hostnames, access paths, credentials, exact recovery sequences, and raw logs before approval.               |
