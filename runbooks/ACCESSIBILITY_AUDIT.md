...
| `/work/conformal-cooling-channel-generation/` | Narrative, Proof, gallery, and Reflection headings retain logical order | Header, main article, sections, evidence gallery, and footer | Native video controls, fallback, and next-work links are reachable | Media captions and EvidenceStrip pass the local Axe gate | Video fallback and primary links meet the target contract | Four responsive evidence images retain descriptive text and captions | Reduced motion preserves posters, stills, and the complete narrative | `@accessibility`, `@work`, `@noscript` | Pass locally |
| `/work/openxhc-linuxcnc/` | Narrative, decisions, Proof, and Reflection headings retain logical order | Header, main article, sections, and footer | Native video controls, project-video fallback, and next-work link are reachable | Media caption and EvidenceStrip pass the local Axe gate | Video fallback and primary links meet the target contract | Sanitized machine media retains descriptive text and an explicit no-write boundary | Reduced motion preserves the poster and complete offline-codec narrative | `@accessibility`, `@work`, `@noscript` | Pass locally |
| `/work/mac-mini-shelf/` | Agentic loop, process, and evidence headings retain logical order | Header, main article, process, gallery, and footer | Original-image and next-work links are reachable | Process cards and media captions pass the local Axe gate | Full-image and primary links remain mobile-safe | Seven authentic CAD/FEM images retain descriptive text and captions | The complete process and lazy-loaded evidence remain available without animation | `@accessibility`, `@responsive`, `@noscript` | Pass locally |
...
| `/work/goatbridge/` | Narrative, Proof, gallery, and Reflection follow a logical order | Header, main article, sections, and footer | Native media controls, video links, and next-work link | Captions use existing evidence tokens | Video links retain the shared target size | Every clip has a descriptive label and scope caption | Posters and full narrative remain useful without playback | `@accessibility`, `@work`, `@noscript` | Local gate passed; shared recruiter aside has a moderate landmark advisory |
